        ...
        <BrowserRouter>
            <MainWrapper>
                <Routes>
                    ...
                    <Route path="/item-registration" element={<PrivateRoute><ItemRegistration /></PrivateRoute>} />
                    <Route path="/item-registration/:id" element={<PrivateRoute><ItemRegistration /></PrivateRoute>} />
